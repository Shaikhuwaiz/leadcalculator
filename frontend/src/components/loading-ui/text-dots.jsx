export function TextDots({ children, className = "", ...props }) {
  return (
    <span className={className} style={{ display: "inline-flex", alignItems: "center", gap: "-3rem" }} {...props}>
      <span>{children}</span>
      <span style={{ display: "inline-flex", gap: "0.1rem", alignItems: "flex-end", paddingBottom: "-3px" }}>
